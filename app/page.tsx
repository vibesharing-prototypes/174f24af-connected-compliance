...
export default function IndexPage() {
  return (
    <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] flex flex-col items-center px-6 py-16">
      <div className="max-w-2xl w-full">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-[#f0f6fc]">Connected Compliance</h1>
        </div>
        <p className="text-sm text-[#6e7681] mb-1">Diligent Prototype — For illustrative and alignment purposes</p>
        <p className="text-sm text-[#8b949e] mb-10 leading-relaxed">
        ...
        <div className="space-y-4">
          {sections.map((s, i) => (
            <Link
              key={s.href}
              href={s.href}
              className="block rounded-xl border border-[#30363d] bg-[#161b22] p-5 hover:border-[#58a6ff]/40 hover:bg-[#161b22]/80 transition-all group"
            >
              <div className="flex items-center gap-3 mb-2">
                <span className="text-xs font-bold text-[#6e7681]">Step {i + 1}</span>
                <span
              ...
              <h2 className="text-base font-bold text-[#f0f6fc] group-hover:text-[#58a6ff] transition-colors mb-1">
                {s.title}
              </h2>
              <p className="text-sm text-[#8b949e] leading-relaxed">{s.description}</p>
            </Link>
          ))}
        </div>
        ...
        <div className="flex justify-center mt-10 mb-2">
          <Link
            href="/light"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-[#30363d] bg-[#161b22] text-sm text-[#8b949e] hover:text-[#f0f6fc] hover:border-[#58a6ff]/40 transition-all"
          >
        ...
        <p className="text-center text-[11px] text-[#30363d] mt-4">
