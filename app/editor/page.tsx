          ...
          <div className="flex-1 overflow-y-auto p-6 min-w-0">
            ...
            <div className="space-y-6">
              ...
              <SuggestionBlock
                ...
                suggestedText="Employees must not offer, promise, give, or receive any financial or other advantage &mdash; directly or through intermediaries &mdash; with the intention of inducing improper conduct. This includes facilitation payments, which are prohibited regardless of local custom or practice, in accordance with the UK Bribery Act 2010 as amended."
          ...
          <div className="w-[380px] flex-shrink-0 border-l border-[#30363d] flex flex-col min-h-0">
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-4">
                ...
                <p className="text-xs text-[#8b949e] mb-4 leading-relaxed">I&apos;ve identified 3 sections that need updates based on recent regulatory changes. Here&apos;s my reasoning for each suggestion:</p>
